...
error_reporting(E_ALL);
	...
	$lines = $auth_user->getAllpasswd($user_id);
...
<center>
    ...
    <header class="banner" style="width:98%;">
		...
		<!-- <br>
		<?php include(__DIR__ . "/../a/amazon.php"); ?>
 -->
<body>
    <nav>
      <ul>
        <div class="dropdown">
				...
				<div class="dropdown">
					...
					<div id="nextDropdown" class="dropdown-content">
						<a href="../f/index.php?filter=search">&rarr; <?php echo ucwords($search) ?></a>
							<?php
									foreach ($groups as $row){
										...
										echo "<a href=\"../f/index.php?filter=".$row["group_name"]."\">&rarr; ".ucwords($real_name)."</a>";
							 		}
							 ?>
					</div>
				</div>
        ...
        <li class="li"><a style="text-decoration: none;" href="../p/"><?php echo " ".$profile ?></a></li>
				&nbsp;&nbsp;
				<li class="li"><a style="text-decoration: none;" href="../../help/"><?php echo " ".$help ?></a></li>
				&nbsp;&nbsp;
        <li class="li"><a style="text-decoration: none;" href="../logout.php"><?php echo $logout ?></a></li>
			...
			<br>
				...
				foreach ($lines as $row) {
					...
					echo "<table>";
					echo "<tr>";
						echo "<th style=\"width:28%\">".ucfirst($field_name)." </th>";
						echo "<th style=\"width:40%\">".ucfirst($item_user)."</th>";
						echo "<th style=\"width:8%\">".ucfirst($item_show)."</th>";
						echo "<th style=\"width:8%\">".ucfirst($newTOTP)."</th>";
						echo "<th style=\"width:8%\">".ucfirst($item_edit)."</th>";
						echo "<th style=\"width:8%\">".ucfirst($item_url)."</th>";
					echo "</tr>";
					...
					$thisURL = openssl_decrypt($row['site_url'],"AES-256-ECB",$auth_user->getUserToken($user_id));
					$newURL = '';
					if (substr($thisURL, 0, 3 ) === "www"){
						$newURL = $auth_user->addhttp($thisURL);
					} else {
						$newURL = $thisURL;
					}
					if (filter_var($newURL, FILTER_VALIDATE_URL)){
						echo "<a href=\"$newURL\" title=\"\" class=\"show-pass\">";
